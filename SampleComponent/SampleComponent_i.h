...
#ifndef __SampleComponent_i_h__
#define __SampleComponent_i_h__
...
EXTERN_C const IID IID_ITest;
    ...
    MIDL_INTERFACE("BA60A5FD-CF6B-4CFA-8748-C1276B67505B")
    ITest : public IDispatch
    {
    public:
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE DoSomething( void) = 0;
    ...
    typedef struct ITestVtbl
    {
        ...
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *DoSomething )( 
            ITest * This);
...
#ifndef __SampleComponentLib_LIBRARY_DEFINED__
#define __SampleComponentLib_LIBRARY_DEFINED__

/* library SampleComponentLib */
/* [version][uuid] */ 


EXTERN_C const IID LIBID_SampleComponentLib;

EXTERN_C const CLSID CLSID_Test;

#ifdef __cplusplus

class DECLSPEC_UUID("21110C90-B78E-436F-9E14-335F961529A4")
Test;
#endif
#endif /* __SampleComponentLib_LIBRARY_DEFINED__ */
